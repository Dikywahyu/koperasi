            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var roleBadgeObj = {
                            Subscriber:
                                '<i class="ri-user-line ri-22px text-success me-2"></i>',
                            Author: '<i class="ri-vip-crown-line ri-22px text-primary me-2"></i>',
                            Maintainer:
                                '<i class="ri-pie-chart-line ri-22px text-info me-2"></i>',
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="javascript:;" class="dropdown-item"><i class="ri-edit-box-line me-2"></i><span><i class="ri-edit-box-line"></i></span></a>' +
