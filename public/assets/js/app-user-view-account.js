...
$(function () {
    ...
    if (dt_invoice_table.length) {
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        var roleBadgeObj = {
                            ...
                            Draft: '<span class="avatar avatar-sm"> <span class="avatar-initial rounded-circle bg-label-primary"><i class="ri-folder-line ri-16px"></i></span></span>',
                            "Past Due":
            ...
            buttons: [
                {
                    extend: "collection",
                    className:
                        "btn btn-primary dropdown-toggle float-end  mb-0 waves-effect waves-light",
        ...
        $(".pagination").addClass(
            "justify-content-xxl-end justify-content-center"
        );
    }
